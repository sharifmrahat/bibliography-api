...
const responseData = (data, res) => {
    ...
    const response = Object.assign(Object.assign(Object.assign({ success: status, statusCode, data: data.result }, (data.message ? { message: data.message } : {})), (data.token ? { token: data.token } : {})), (data.meta ? data.meta : {}));
